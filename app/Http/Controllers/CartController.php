...
class CartController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($duplicata->isNotEmpty()){
            return redirect()->route('products.index')->with('success','Votre produit a été déjà ajouté au panier!');
        }
        ...
        return redirect()->route('products.index')->with('success','Votre produit a été bien ajouté au panier!');
    }
